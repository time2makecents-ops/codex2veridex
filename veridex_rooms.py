...
ROOMS: List[Dict[str, Any]] = [
    ...
    {"id": "art_department", "title": "Visual Design", "default_persona": "Creative Director", "is_active": True},
    {
        ...
        "default_persona": "Leo",
        "is_active": True,
        "purpose": "Buying and selling antiques and vintage collectables, especially art, jewelry, pottery, and vintage kitchen and service items.",
        "capabilities": [
            "item identification and description",
            "condition and authenticity research",
            "market and comparable-sale research",
            "buying and selling evaluations",
            "listing and catalog copy",
            "inventory and provenance tracking",
        ],
    },
